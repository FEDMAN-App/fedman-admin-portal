...
class CreateNewDisciplineScreen extends StatefulWidget {
  final int? disciplineId;
  
  const CreateNewDisciplineScreen({super.key, this.disciplineId});

  @override
  State<CreateNewDisciplineScreen> createState() => _CreateNewDisciplineScreenState();
}

class _CreateNewDisciplineScreenState extends State<CreateNewDisciplineScreen> 
  ...
  void initState() {
    ...
    if (widget.disciplineId != null) {
      // TODO: Load discipline data for editing
      // When loading existing discipline, populate levels from API
    }
  }
      ...
      child: ResponsiveRowColumn(
        ...
        children: [
          ...
          CustomButton(
            ...
            onTap: () {
              // TODO: Implement create/update discipline logic
            },
